...
if documentos:
    ...
    df.to_csv("eventos_exportados.csv", index=False, encoding="utf-8")
    print("✅ Exportación completada: eventos_exportados.csv")
else:
    print("⚠ No se encontraron documentos en la colección 'eventos'.")
